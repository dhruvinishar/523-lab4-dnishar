...
```{r Question-5-code-chunk, include=TRUE, warning=TRUE}
print("This is the Question 5 code chunk with code chunk options {eval=TRUE, echo=TRUE, warning=TRUE}. The multiple code chunk options defined in this code chunk lets us customize the behavior of the code chunk, here, the 'eval=TRUE' option lets us evaluate the code and include the results as the output. The 'echo=TRUE' option is used to display the code along with its results, 'warning=TRUE' option displays warning messsages for the chunk.")

warning('This is a warning message that the chunk allows us to print because of the option')
```
